...
!===============================================================
      ...
      do i=1,ntsteps
      	...
      	call findrhs(b,xold,source,dirc_bc_flags,&
			 flux_bc_flags,dircvals,fluxvals,h,dt,n)
	x=xold

	!call gauss_seidel_smoothing(res,b,x,vel,dcoeff,reac,&
	!	dirc_bc_flags,flux_bc_flags,dircvals,&
	!			fluxvals,h,dt,n,500)

	!do nv=1,1

	!	call dovcycle(x,b,vel,dcoeff,reac,&
	!	dirc_bc_flags,flux_bc_flags,dircvals,&
	!			fluxvals,h,dt,n)
...
!	enddo
 	call performgmres(b,xold,x,vel,dcoeff,reac,dirc_bc_flags,&
